...
const QuizDetail = () => {
  ...
  return (
    <div style={{ marginTop: 30, padding: 20 }}>
      <Card title={`Đề thi thử: ${quizDetail.exam_display_name}`}>
        <Row gutter={[16, 16]}>
          <Col xs={24} sm={12}>
          ...
          <Col xs={24} sm={12}>
            ...
            <p>Điểm qua môn: {quizDetail.pass_score} trên tổng số {quizDetail.max_score}</p>
            <Button type="primary" onClick={handleStartQuiz} style={{ marginTop: 10, backgroundColor: 'blue'}}>
              Làm bài
            </Button>
          </Col>
        </Row>
